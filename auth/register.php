...
<head>
    ...
    <style>
        ...
        .register-box { width: 420px; margin: 50px auto; background: white; padding: 20px; border-radius: 5px; box-shadow: 0 0 10px #ccc; }
        input, select, button { width: 100%; padding: 8px; margin-top: 10px; box-sizing: border-box; }
